...
(function () {
  ...
  const translations = {
    es: {
      ...
      tip2_text:  "No necesitas las más caras; necesitas unas que se sientan cómodas. Pruébate varios modelos y elige el que mejor se adapte a ti. Si puedes, pide un análisis de marcha para orientación adicional.",
      tip3_title: "Correr Lento para Correr Rápido",
      tip3_text:  "El 80% de tus rodajes deben ser muy suaves, ritmo donde puedas hablar. La velocidad llega después, cuando tu base aeróbica mejora.",
      tip4_title: "Hidratación Antes y Después",
      tip4_text:  "Hidrátate desde 2 horas antes. Una buena hidratación mejora tu rendimiento entre un 2% y 10%. El color de la orina es tu mejor indicador.",
      tip5_title: "Descanso = Progreso",
      tip5_text:  "El progreso ocurre en el descanso, no en el entrenamiento. La fatiga acumulada por entrenar demasiado rápido es el error #1 de los principiantes.",
      tip6_title: "Inscríbete a una Carrera",
      tip6_text:  "Tener una fecha en el calendario te da una motivación increíble. Busca una 5K o 10K y anótate cuando te sientas listo.",
      plan_label: "Plan de entrenamiento",
      plan_title: "8 Semanas<br>a tu 10K",
      plan_desc:  "Este es el plan base. Cada semana lo detallo en Instagram con videos, reels y tips específicos.",
      col_week: "SEMANA", col_focus: "ENFOQUE", col_km: "KM TOT.",
      w1_num: "SEM 01", w1_desc: "Correr/caminar – construir el hábito",
      w2_num: "SEM 02", w2_desc: "20 min corriendo – primera prueba",
      w3_num: "SEM 03", w3_desc: "Resistencia aeróbica base",
      w4_num: "SEM 04", w4_desc: "Primer rodaje de 5K continuo",
      w5_num: "SEM 05", w5_desc: "Aumento de volumen + técnica",
      w6_num: "SEM 06", w6_desc: "Rodaje largo 7K + recuperación",
      w7_num: "SEM 07", w7_desc: "Simulacro de carrera – 7-8K",
      w8_num: "SEM 08", w8_desc: "🏁 CARRERA – Tu primer 10K oficial",
      plan_note:   "* Cada semana tiene 3 días de entrenamiento + descanso activo. Sígueme en Instagram para los detalles de cada sesión.",
      cta_heading: "Tu <span class=\"accent\">10K</span><br>empieza hoy",
      cta_sub:     "Cada semana subo tips, planes y contenido real sobre el camino de novato a corredor. Únete a la comunidad.",
      cta_btn:     "Seguir @arielvillalona_",
      cta_note:    "Gratis · Sin spam · Solo running",
      footer_desc: "De novato a corredor de carrera. Contenido de running en español.",
    ...
    en: {
      ...
      tip2_text:  "You don't need the most expensive ones — you need the right ones. Try multiple models and get a gait analysis if possible.",
      tip3_title: "Run Slow to Run Fast",
      tip3_text:  "80% of your runs should feel easy — a pace where you can hold a conversation. Speed comes later, as your aerobic base grows.",
      tip4_title: "Hydrate Before and After",
      tip4_text:  "Start hydrating 2 hours before your run. Good hydration can improve your performance by 2%–10%. Urine color is your best indicator.",
      tip5_title: "Rest = Progress",
      tip5_text:  "Progress happens during recovery, not during training. Building up too fast is the #1 mistake beginner runners make.",
      tip6_title: "Sign Up for a Race",
      tip6_text:  "Having a race on the calendar gives you incredible motivation. Find a local 5K or 10K and register when you feel ready.",
      plan_label: "Training plan",
      plan_title: "8 Weeks<br>to your 10K",
      plan_desc:  "This is the base plan. Every week I break it down on Instagram with videos, reels, and specific tips.",
      col_week: "WEEK", col_focus: "FOCUS", col_km: "TOTAL KM",
      w1_num: "WK 01", w1_desc: "Run/walk – building the habit",
      w2_num: "WK 02", w2_desc: "20 min running – first test",
      w3_num: "WK 03", w3_desc: "Aerobic base endurance",
      w4_num: "WK 04", w4_desc: "First continuous 5K run",
      w5_num: "WK 05", w5_desc: "Volume increase + technique",
      w6_num: "WK 06", w6_desc: "Long run 7K + recovery",
      w7_num: "WK 07", w7_desc: "Race simulation – 7–8K",
      w8_num: "WK 08", w8_desc: "🏁 RACE DAY – Your first official 10K",
      plan_note:   "* Each week includes 3 training days + active recovery. Follow me on Instagram for each session's details.",
      cta_heading: "Your <span class=\"accent\">10K</span><br>starts today",
      cta_sub:     "Every week I post tips, plans, and real content about going from beginner to race-day runner. Join the community.",
      cta_btn:     "Follow @arielvillalona_",
      cta_note:    "Free · No spam · Just running",
      footer_desc: "From beginner to race runner. Running content in Spanish & English.",
      footer_copy: "© 2025 RunProgress · All rights reserved",
      ticker: ["Start today","Running tips","0 to 10K","No injuries","Real progress","First race","Consistency > Speed"]
    }
  };
